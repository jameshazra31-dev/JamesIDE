...
android {
  ...
  // James IDE: use the custom keystore only when its passwords are provided.
  // Otherwise fall back to the default debug signing so the project builds
  // out of the box with `./gradlew :core:app:assembleDebug`.
