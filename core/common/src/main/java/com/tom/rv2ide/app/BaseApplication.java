...
public class BaseApplication extends Application {
  ...
  public static final String TELEGRAM_GROUP_URL = "https://github.com/james/james-ide/discussions";
  public static final String TELEGRAM_CHANNEL_URL = "https://github.com/james/james-ide/releases";  
  public static final String SPONSOR_URL = BuildInfo.REPO_URL;
  public static final String DOCS_URL = "https://github.com/james/james-ide/tree/dev/docs";
  public static final String CONTRIBUTOR_GUIDE_URL =
      BuildInfo.REPO_URL + "/blob/dev/docs/en/CONTRIBUTING.md";
  public static final String EMAIL = "raloci1063@gicont.com";
