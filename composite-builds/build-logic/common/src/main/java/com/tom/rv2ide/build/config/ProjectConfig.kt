...
object ProjectConfig {
  ...
  */
  ...
  const val REPO_OWNER = "james"
  const val REPO_NAME = "james-ide"

  const val ACS_BUILD_SYSTEM_REPONAME = "acs-build-system"
  // NOTE: kept pointing at the original infrastructure repo so build-tools downloads keep working
  const val ACS_BUILD_SYSTEM_REPOURL = "https://$REPO_HOST/AndroidCSOfficial/$ACS_BUILD_SYSTEM_REPONAME"
